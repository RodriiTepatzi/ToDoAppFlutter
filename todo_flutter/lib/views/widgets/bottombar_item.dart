...
class BottomBarItem extends StatelessWidget {
  const BottomBarItem(this.icon, {this.onTap, this.color = bottomBarItemColor, this.activeColor = bottomBarItemActiveColor, this.isActive = false, this.isNotified = false});
  final String icon;
  final Color color;
